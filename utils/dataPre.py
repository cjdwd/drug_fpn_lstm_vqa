...
#         img = Image.fromarray(contactmap.numpy().squeeze(),mode='F')
#         contactmap = np.asarray(img.resize((224,224)))
...
# testFoldPath = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/data/DUDE/dataPre/DUDE-foldTest4'
# trainFoldPath = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/data/DUDE/dataPre/DUDE-foldTrain4'
# contactPath = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/distance_map/distance_map'
# contactDictPath = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/data/DUDE/dataPre/DUDE-contactDict'
# smileLettersPath  = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/data/DUDE/voc/combinedVoc-wholeFour.voc'
# seqLettersPath = '/GPUFS/nsccgz_ywang_zfd/caojindong/drugVQA/data/DUDE/voc/sequence.voc'
